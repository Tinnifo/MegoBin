...
def canonical_genome_fixture() -> "SyntheticGenomeSet":
    """The shared synthetic genome set used across the fidelity suite.

    The default fixture for the harness-validation tests (self-oracle
    discrimination + ground-truth recovery). ``n_noise=60`` gives a comfortable
    faithful-vs-divergent margin.
    """
